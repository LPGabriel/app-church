import { Box, Center, chakra, HTMLChakraProps } from '@chakra-ui/react'
import Image from 'next/image'

import logoBlack from '../assets/Logo/Rocket-Escola-de-Negocios-black.png'
import logoWhite from '../assets/Logo/Logo-Rocket-Escola-de-Negocios-white.png'

export const Logo = ({color, height}) => {

  return (
    <Center>
      <Image placeholder='blur' alt='Rocket Escola de Negócios' height={height ? height : 50} src={color == 'white' ? logoWhite : logoBlack} />
    </Center>
    // <chakra.svg
    //   color="accent"
    //   height="12"
