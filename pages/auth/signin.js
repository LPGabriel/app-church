...
import profilePic from "/home/meulinux/Projetos/app-church/public/logologin.png"


export default function SignIn({ csrfToken }) {
  return (
    <div className="h-screen pt-10 pb-10 flex justify-center">

      <div className="flex px-6 drop-shadow-2xl lg:w-3/4">
        <div className="bg-black hidden w-1/2 rounded-l-lg lg:flex flex-col justify-center" >
          <Image
            src={profilePic}
        ...
        <div className="bg-white p-10 gap-6 flex flex-col rounded-lg lg:w-1/2 justify-center lg:rounded-l-none">
          ...
          <div className="text-center">
            <h1 className="text-4xl mb-2 text-azul-escuro">Já tem acesso com a gente?</h1>
            <p className="text-xl text-gray-700 mb-2">
              Faça seu login e ótima imersão!
            </p>
          </div>
